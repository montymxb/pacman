...
var PACMAN_MOVING_SPEED = 15 / GameSpeedRatio;
...
var PACMAN_KILLING_SPEED = 70 / GameSpeedRatio;
var PACMAN_RETRY_SPEED = 2100  / GameSpeedRatio;
...
function movePacman(direction, test) {

	if (PACMAN_MOVING === false && !test) {
		PACMAN_MOVING = true;
		drawPacman();
	...
	// if no direction to try, or try direction does not match existing direction
